...
RSpec.describe MetadataListener::Service::Tika do
  ...
  context 'with a pdf' do
    ...
    its(:metadata) { is_expected.to include('dc:creator' => 'Florian Grandel') }
  end
  ...
  context 'with a Word document' do
    ...
    its(:metadata) { is_expected.to include('extended-properties:Application' => 'Microsoft Office Word') }
  end
  ...
  context 'with a PowerPoint document' do
    ...
    its(:text) { is_expected.to include('chambray') }
    its(:metadata) { is_expected.to include('extended-properties:Application' => 'Microsoft Macintosh PowerPoint') }
  end
